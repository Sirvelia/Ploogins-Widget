                ...
                <div class="ploogins:flex ploogins:flex-col ploogins:gap-4">
                    ...
                    <div class="ploogins:flex ploogins:gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                            viewBox="0 0 24 24" class="ploogins:fill-black ploogins:text-black ploogins:min-w-8 ploogins:min-h-8">
                        ...
                        <span v-else class="ploogins:text-2xl">{{ insights?.main_purpose }}</span>
                    </div>
                </div>
            </div>
